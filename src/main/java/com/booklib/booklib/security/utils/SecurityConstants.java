package com.booklib.booklib.security.utils;
...
public class SecurityConstants {
	...
	public static final String SECRET_KEY = "mySuperUltraSecretKey";


	public static final String ISSUER = "Jimmy's authontication";
